...
ASS_PATH = VIDEO_DIR / "baifa-relations.ass"
INPUT_MP4 = VIDEO_DIR / "baifa-relations.mp4"
OUTPUT_MP4 = VIDEO_DIR / "baifa-relations-hard.mp4"
...
ASS_STYLE = {
    ...
    "Fontsize": 32,                    # ASS units; with PlayResY=1104 this lands ~28-32px on screen
    ...
    "BackColour": "&H64000000",        # 50% black box shadow (alpha 64 = 40% transparent)
    "Bold": 0,
    "Italic": 0,
    "Underline": 0,
    "StrikeOut": 0,
    ...
    "Outline": 2,                      # outline width in pixels

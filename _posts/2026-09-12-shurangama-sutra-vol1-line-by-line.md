...
* 说明：卷帙较长，按文意**逐段**（不逐字为句）注解；每段给出经文原文 + 白话直译 + 义理解释 + 术语解释，引及的经论原文另列「参考」；标题即经文原文。个别异体字依流通本习惯改为通行字（呪→咒、毘→毗、瑠璃→琉璃、勅→敕等）。卷一解读的主线一句话：**先认清生死的根子是错认攀缘心为自己，再指出人人现前本有的不动见性——舍妄识、认真心**
